...
namespace CuaHangSach
{
    public partial class frmNhanVien : Form
    {
        ...
        private void Init()
        {
            string cnstr = " Server = .; Database = Cua_Hang_Sach; Integrated Security = true";
        ...
        private void bt2_Click(object sender, EventArgs e)
        {
            ...
            else if (txt1.Text == "" || txt2.Text == "" || txt3.Text == "" || cbb1.Text == "" || txtNgaySinh.Text == "" || txt4.Text == "" || txt5.Text == "" || txt6.Text == "" || txt7.Text == "" || txt8.Text == "" || txt9.Text == "" || txt10.Text == "" || txtTinhTrang.Text == "")
            {
        ...
        private void bt4_Click(object sender, EventArgs e)
        {
            ...
            {
                if (txt1.Text.Trim() == "" || txt2.Text.Trim() == "" || txt3.Text.Trim() == "" || cbb1.Text.Trim() == "" || txtNgaySinh.Text.Trim() == "" || txt4.Text.Trim() == "" || txt5.Text.Trim() == "" || txt6.Text.Trim() == "" || txt7.Text.Trim() == "" || txt8.Text.Trim() == "" || txt9.Text.Trim() == "" || txt10.Text.Trim() == "" || txtTinhTrang.Text.Trim() == "")
                {
